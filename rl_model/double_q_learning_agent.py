...
class Agent:
    ...
    def _construct_memories(self, replay):
        ...
        #         print(states.shape)
        new_states = np.array([a[3][0] for a in replay])
    ...
    def buy(self, initial_money, close):
        ...
        for t in range(0, len(self.trend) - 1, self.skip):
            ...
            if action == 1 and len(buy_list) <= 0 and initial_money >= self.trend[t][0]:
    ...
    def train(self, iterations, checkpoint, initial_money):
        for i in range(iterations):
            ...
            for t in range(0, len(self.trend) - 1, self.skip):
                ...
                if action == 1 and len(buy_list) <= 0 and starting_money >= self.trend[t][0]:
                    inventory.append(self.trend[t][0])
