...
class Kiwoom(QAxWidget):
    ...
    def connect_event_handler(self):
        ...
        # self.connect(self, SIGNAL("OnReceiveRealData(QString, QString, QString)"), self._OnReceiveRealData)
    ...
    def _OnReceiveTrData(self, ScrNo, RQName, TrCode, RecordName, PrevNext, DataLength, ErrorCode, Message, SplmMsg):
        ...
        self.data_len = self.GetRepeatCnt(TrCode, RQName)  # 데이터 길이 Get
        print("TR 조회명 : " + RQName) 
        print("레코드 반복 횟수 : " + str(self.data_len))
        print("")
        ...
        if RQName == "주식일봉차트조회요청":
            ...
            print("총매입금액 : " + Kiwoom.change_format(self.CommGetData(TrCode, "", RQName, 0, "총매입금액")))
            print("총평가금액 : " + Kiwoom.change_format(self.CommGetData(TrCode, "", RQName, 0, "총평가금액")))
            print("총평가손익금액 : " + Kiwoom.change_format(self.CommGetData(TrCode, "", RQName, 0, "총평가손익금액")))
            ...
            for i in range(0, self.data_len):
                ...
                print("보유수량 : " + Kiwoom.change_format(self.CommGetData(TrCode, "", RQName, i, "보유수량")))
                print("매입가 : " + Kiwoom.change_format(self.CommGetData(TrCode, "", RQName, i, "매입가")))
                print("매입금액 : " + Kiwoom.change_format(self.CommGetData(TrCode, "", RQName, i, "매입금액")))
            ...
            for i in range(0, self.data_len):
                ...
                print(str(i) + ". " + self.CommGetData(TrCode, "", RQName, i, "종목명") + " : " + self.CommGetData(TrCode, "", RQName, i, "현재가"))
    ...
    def _OnReceiveRealData(self, code, realType, realData):
        ...
        print("시가 : " + self.GetCommRealData(code, 16))
        print("고가 : " + self.GetCommRealData(code, 17))
        print("저가 : " + self.GetCommRealData(code, 18))
        print("누적거래량 : " + self.GetCommRealData(code, 13))
        # print("체결강도 : " + self.GetCommRealData(code, 228))
        # print("체결 시간 (HHMMSS) : " + self.GetCommRealData(code, 20))
    ...
    def SetRealReg(self, sScrNo, codeList, fidList, optType):
        # 실시간 등록을 한다.
        # strScreenNo : 화면번호
        ...
        self.dynamicCall("SetRealReg(QString, QString, QString, QString)", sScrNo, codeList, fidList, optType)
        self.real_event_loop = QEventLoop()
        self.real_event_loop.exec()
    ...
    def CommKwRqData(self, arrCode, next, codeCount, typeFlag, rQName, screenNo):
        print("호출")
        self.dynamicCall("CommKwRqData(QString, QBoolean, int, int, QString, QString)", arrCode, next, codeCount,
